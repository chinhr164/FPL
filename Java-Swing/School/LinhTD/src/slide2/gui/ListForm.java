...
public class ListForm extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnAdd1, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
                        .addGap(28, 28, 28))))
        );
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        model.setColumnIdentifiers(new String[]{"Mã SV","Tên SV","Quê quán"});
        
        list.add(new Student(txtId.getText(),txtName.getText(),txtCountry.getText()));
        for (Student sv : list){
            model.addRow(new String[]{sv.getId(),sv.getName(),sv.getCountry()});
        }
...
//        ArrayList<Student> list = new ArrayList<>();
//        for (int i = 0; i < 3; i++) {
//           list.add(new Student("SV"+(i+1),"CH"+(i+1),"QQ"+(i+1)));
//        }
        DefaultTableModel model = new DefaultTableModel();
        model.setColumnIdentifiers(new String[]{"Mã SV","Tên SV","Quê quán"});
//        for (Student sv : list){
